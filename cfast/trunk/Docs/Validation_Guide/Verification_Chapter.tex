...
In order to understand the meaning of model verification, it is also  necessary to understand the
...
The CFAST Technical Reference Guide \cite{CFAST_Tech_Guide_7} contains a detailed description of the CFAST subroutine structure and interactions between the subroutines.
