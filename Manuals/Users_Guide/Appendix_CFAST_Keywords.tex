...
{\ct ADIABATIC\_TARGET\_VERIFICATION}\footnote{If included, must be either {\ct ON} or {\ct OFF} \label{DIAGonoff}} \footnote{If {\ct ON}, {\ct RADIATIVE\_INCIDIENT\_FLUX\_AST} is required.}     & Selection List   &          &         &  {\ct OFF}      \\ \hline
...
{\ct RADIATIVE\_INCIDIENT\_FLUX\_AST}           & Real    &         & kW/m$^2$           & 0      \\ \hline
