% !TEX root = ../CFAST_Configuration_Guide/CFAST_Configuration_Guide.tex
...
CFAST was developed and is maintained by the Fire Research Division of the National Institute of Standards and Technology. The original developers were Walter Jones,  Richard Peacock, Glenn Forney, and Paul Reneke. Randall McDermott and Kevin McGrattan of NIST as well as Jason Floyd and Jonathan Hodges of UL Research Institutes' Fire Safety Research Institute have taken over responsibility for the maintenance of the software.

\section{Relevant Publications}

The manuals for CFAST consist of this Technical Reference Guide, a User's Guide~\cite{CFAST_Users_Guide_8}, a Verification and Validation Guide~\cite{CFAST_Valid_Guide_8}, and a Configuration Management Guide~\cite{CFAST_Config_Guide_8}.  The Technical Reference Guide describes the underlying physical principles. The User's Guide describes how to use the model. The Verification and Validation Guide documents sensitivity analyses, model verification, model validation, and model limitations consistent with ASTM~E1355~\cite{CFAST:ASTM:E1355}. The Configuration Management Guide documents the processes used during the development and validation of the model.
...
\end{itemize}
The input files are provided for the validation exercises described in the Validation Guide~\cite{CFAST_Valid_Guide_8}. A complete description of the input parameters can be found in the CFAST User's Guide~\cite{CFAST_Users_Guide_8}.
...
The outputs of CFAST are the sensible variables that are needed for assessing the environment in a building subjected to a fire. Once the simulation is complete, CFAST produces an output file containing all of the solution variables.  Typical outputs include (but are not limited to) the following:
\begin{itemize}
