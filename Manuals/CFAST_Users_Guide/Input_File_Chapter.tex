...
\item[Conductivity] (default units: kW/(m$\cdot$K); namelist: \ct{CONDUCTIVITY}) Thermal conductivity for the material. Note the units---this property is often listed in units of W/(m$\cdot$K).

\item[Specific Heat] (default units: kJ/(kg$\cdot$K); namelist: \ct{SPECIFIC_HEAT}) Specific heat for the material.

\item[Density] (default units: kg/m$^3$; namelist: \ct{DENSITY}) Density of the material.
