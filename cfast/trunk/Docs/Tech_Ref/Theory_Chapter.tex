...
The remaining stoichioimetry falls directly from the chemical balance as
\be
  \nu_\COTWO = \mathrm{n_\C} - \brackets{\nu_\CO + \nu_\HCN + \nu_\So}
\ee
\be
  \nu_\HTWOO = \frac{\mathrm{n_\Hy} - \nu_\HCl+\nu_\HCN}{2}
\ee

\begin{eqnarray} \nu_\OTWO &=& \nu_\COTWO + \frac{\nu_\HTWOO + \nu_\CO - \mathrm{n_\N}}{2} \label{Oxygen_yield} \\
 &=& \mathrm{n_\C} - \brackets{\nu_\CO + \nu_\HCN + \nu_\So}+\frac{\nu_\CO}{2}+\frac{\mathrm{n_\Hy} - \nu_\HCl+\nu_\HCN}{4}-\frac{\mathrm{n_\Oh}}{2} \\
 &=& \frac{4 \mathrm{n_\C+n_\Hy}}{4}-\frac{\mathrm{n_\Oh}}{2}-\brackets{\frac{2 \nu_\So-\nu_\CO}{2}+\frac{5 \nu_\HCN+\nu_\HCl}{4}}\\
...
oxygen to form carbon dioxide and water. The only input required is the heat release rate and the
...
\be T_p = \frac{\dm_f c_pT_f+ dm_lc_pT_l}{\brackets{\dm_f + \dm_e}c_p} > T_u \ee
or
