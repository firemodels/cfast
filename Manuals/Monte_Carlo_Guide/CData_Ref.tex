...
\begin{description}
  ...
  \item[DISTRIBUTION] identifies the type of distribution. Additional required inputs depend of the type of distribution defined. Allowed distributions are {\ct UNIFORM}, {\ct TRIANGLE}, {\ct NORMAL}, {\ct LOG\_NORMAL}, {\ct BETA}, {\ct USER\_DEFINED}, and {\ct LINEAR }.
