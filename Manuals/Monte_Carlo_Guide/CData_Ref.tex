...
\includegraphics{FIGURES/ex2_cvg_plot-1.pdf}
...
\includegraphics{FIGURES/converg-1.pdf}
\includegraphics{FIGURES/converg-2.pdf}

The prelinary results, charted above, suggest that we have enough cases. The averages all appear to have converged, and the standard errors are small.
...
The table above displays the number of cases where each of the alarms activated. Cases marked NA, are cases where the model itself did not converge. That was a very small number of cases for this example.
...
\includegraphics{FIGURES/cart-1.pdf}
