...
{\ct CEILING\_JET\_SUB\_MODEL}     & Selection List   &          &         &  ON      \\ \hline
{\ct CONDUCTION\_SUB\_MODEL}     & Selection List   &          &         &  ON      \\ \hline
{\ct CONVECTION\_SUB\_MODEL}      & Selection List   &          &         & ON      \\ \hline
{\ct DASSL\_DEBUG\_PRINT}            & Selection List   &          &         & OFF     \\ \hline
{\ct DEBUG\_PRINT}                          & Selection List   &          &         & OFF     \\ \hline
{\ct DOOR\_JET\_FIRE\_SUB\_MODEL}  & Selection List &        &         & ON       \\ \hline
{\ct ENTRAINMENT\_SUB\_MODEL }   & Selection List    &         &          & ON       \\ \hline 
{\ct F}\footnote{If included, both {\ct F} and {\ct T} are required.}          & Real Array       &                  &  \degc         &                 \\ \hline
{\ct FIRE\_SUB\_MODEL}                     & Selection List   &          &          & ON       \\ \hline
{\ct GAS\_TEMPERATURE}\footnote{If included, {\ct GAS\_TEMPERATURE}, {\ct PARTIAL\_PRESSURE\_H2O}, and {\ct PARTIAL\_PRESSURE\_CO} are all required.}             & Real   &                  &  \degc         &                 \\ \hline
{\ct HORIZONTAL\_FLOW\_SUB\_MODEL} & Selection List &     &           & ON       \\ \hline
{\ct KEYBOARD\_INPUT}                    & Selection List    &          &           & ON      \\ \hline
{\ct MECHANICAL\_FLOW\_SUB\_MODEL} & Selection List &      &           & ON      \\ \hline
{\ct OXYGEN\_TRACKING}                  & Selection List    &         &            & OFF    \\ \hline
{\ct PARTIAL\_PRESSURE\_CO}             & Real   &                  &    Pa       &                 \\ \hline
{\ct PARTIAL\_PRESSURE\_H2O}             & Real   &                  &   Pa        &                 \\ \hline
{\ct RADIATION\_SUB\_MODEL}           & Selection List    &         &            & ON      \\ \hline
{\ct RADSOLVER}\footnote{{\ct RADSOLVER}, if included, must be either {\ct DEFAULT} or {\ct RADNET}.}            & Selection List   &                  &           &  DEFAULT               \\ \hline
{\ct STEADY\_STATE\_INTIAL\_CONDITIONS} & Selection List &     &     & OFF     \\ \hline
{\ct T}          & Real Array       &                  & s          &                 \\ \hline
{\ct VERTICAL\_FLOW\_SUB\_MODEL} & Selection List &            &             & ON      \\ \hline
\end{longtable}
\end{minipage}
