...
%% Do we want to group this stuff like it is on the tab
\begin{description}
...
%% Maybe this should be a subsection in the intitial conditions section
...
%% Two things. One have we changed the max no of compartments
%% Two do we want to make clear here or in the Geomentry section that Postion X and Postion Y do not have an impact on the calculation
...
%% Sholuldn't this just be taken out. We don't do this anymore do we?
%%
