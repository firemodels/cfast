...
Wall and target temperature profiles are advanced in time using the heat equation. The heat conduction equation normal to the solid surface is:
...
\ee
Dividing the cylinder into $N$ uniformly spaced concentric control volumes, this equation can be written in discretized form, where $T_i^n \equiv \Ts(x_i,t_n)$:
\begin{eqnarray}
