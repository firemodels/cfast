...
or a pressure rise of 1192.3 Pa. Figure \ref{fig:Added_Mass_Test} shows the simulated conditions for this test.

\begin{figure}
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
%\includegraphics[width=3.0in]{FIGURES/Verification/Added_Mass_Temperature} &
%\includegraphics[width=3.0in]{FIGURES/Verification/Added_Mass_Pressure}
\end{tabular*}
