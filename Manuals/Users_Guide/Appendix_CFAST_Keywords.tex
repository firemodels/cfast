...
Wall vent
&VENT
	ID = 'Door Outside', TYPE = 'WALL', COMP_IDS = 'Comp 1', 'OUTSIDE',
	BOTTOM = 0., TOP = 2., WIDTH = 1.,
	FACE = 'FRONT',
	OFFSETS = 2.5, 0. /  Vent is fully opened at time = 0s.

Floor vent
&VENT
	ID = 'Floor Hole', TYPE = 'FLOOR', COMP_IDS = 'Comp 3', 'Comp 2',
	AREA = 1., SHAPE = 'ROUND',
	DEVC_ID = 'Targ 1', CRITERION= 'TEMPERATURE', SETPOINT = 300.,
	OFFSETS = 2.5, 2.5 /

Mechanical vent
&VENT
	ID = 'HVAC', TYPE = 'MECHANICAL', COMP_IDS = 'Comp 2', 'OUTSIDE',
	AREAS = 0.25, 0.25, HEIGHTS = 2.75, 2.75,
	CRITERION = 'TIME', OPENING_RAMP_ID = 'Fire Exhaust',
	FLOW = 0.02, CUTOFFS = 150., 200., FILTERING_RAMP_ID = 'Filter 1',
	OFFSETS = 0.,4. /
\end{lstlisting}
