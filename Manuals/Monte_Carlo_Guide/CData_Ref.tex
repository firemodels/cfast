...
\subsection{Example 1: Impact of inner liners on residential upholstered furniture fires}

In this example we look at a single room and the impact of inner liners on the hazard posed by residential upholstered furniture (RUF).

\subsection{Example 2: Impact of new detector standard}

In this example we look at the potential impact of the new Underwriters Labroratory's (UL) new smoke detector standard. We will use a single story ranch house with various fire and detector locations.

\subsection{Example 3: Impact of periodically active wireless detectors}

For the final example we look at the impact of a periodic activation of wireless communications in detectors. We will use the ranch house from example 2 and a two story house to broden the analysis.
