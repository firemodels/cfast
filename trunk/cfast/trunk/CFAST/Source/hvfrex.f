...
C
C     INITIALIZE THE PARAMETERS USED BY THE MECHANICAL VENTILATION ROUTINES
...
C     CHANGED  6/14/92
C     CHANGED 11/09/92 - FROM HARMONIC MEAN TO DISTINCT TEMPERATURES FOR THE TWO LAYERS
