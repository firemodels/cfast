...
\begin{description}
  ...
  \item[TIME\_TO\_1054\_KW] specifies the time for the growth phase of a power law fire to grow from 0~kW to 1054~kW. Must be a positive number. Only one of {\ct GROWTH\_EXPONENT} or \\
      {\ct TIME\_TO\_1054\_KW} can be included in an {\ct \&MFIR} input.
  ...
  \item[TIME\_TO\_0\_KW] specifies the time for the growth phase of a power law fire to decay from its peak value to 0~kW. Must be a positive number. Only one of {\ct DECAY\_EXPONENT} or \\
      {\ct TIME\_TO\_0\_KW} can be included in an {\ct \&MFIR} input.
