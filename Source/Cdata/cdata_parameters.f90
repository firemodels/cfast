    ...
    integer, parameter :: mxpntsarray = 100, mxranddists = 9, mxgenerators = 200, mxvaltypes = 4, mxseeds = 2
    ...
    integer, parameter :: idx_log_normal = 7, idx_const = 8, idx_value = 9, mxfields = 100
