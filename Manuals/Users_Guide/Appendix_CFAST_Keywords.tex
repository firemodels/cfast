...
{\ct TEMPERATURES(1:2)}          & Real Array  	           & Section \ref{info:INIT}      & $^\circ$C		     & 20, 20  		               \\ \hline
\end{longtable}
...
&INIT  PRESSURE = 101325., RELATIVE_HUMIDITY = 50., TEMPERATURES(1:2) = 20., 20. /
...
{\ct SETPOINT}\footnote{For smoke detectors, this is obscuration; for heat detectors or sprinklers, the input is temperature.}
	                  & Real        & Section \ref{info:DEVC}     & $^\circ$C or \%/m &     23.93 \%/m  \\ \hline
...
{\ct A}               & Real Array            & Section \ref{info:RAMP2}                 &  m$^2$   &                 \\ \hline
{\ct H}               & Real Array            & Section \ref{info:RAMP2}                 &  m       &                 \\ \hline
{\ct HRR}             & Real Array            & Section \ref{info:RAMP2}                 &  kW      &                 \\ \hline
{\ct ID}              & Character             & Section \ref{info:RAMP2}                 &          &                 \\ \hline
{\ct T}               & Real Array            & Section \ref{info:RAMP2}                 &  s       &                 \\ \hline
{\ct TYPE}\footnote{{\ct AREA}, {\ct EFFICIENCY}, {\ct FRACTION}, or {\ct HEAT\_RELEASE\_RATE}}
                      & Selection List        & Section \ref{info:RAMP2}                 &          &                 \\ \hline
\end{longtable}
