...
\endhead
\parbox{1.5in}{\bf Parameter}    & \parbox{1in}{\bf Type}  & \parbox{1in}{\bf Reference}  & \parbox{1in}{\bf Units}  & \parbox{1in}{\bf Default Value} \\ \hline
{\ct ADIABATIC\_TARGET}\footnote{ Input for {\ct CONVECTION\_COEFFICENTS} are required.}           					 & Logical  		  & Section \ref{info:DEVC}      &                             &  {\ct .FALSE.}     \\ \hline
...
{\ct ADIABATIC\_TARGET\_VERIFICATION}\footref{DIAGonoff} \footnote{{\ct ADIABATIC\_TARGET\_VERIFICATION}, if on,{\ct RADIATIVE\_INCIDIENT\_FLUX\_AST} is required.}     & Selection List   &          &         &  {\ct OFF}      \\ \hline
{\ct CEILING\_JET\_SUB\_MODEL}\footnote{If included, must be either {\ct ON} or {\ct OFF} \label{DIAGonoff}}    & Selection List   &          &         &  {\ct ON}      \\ \hline
...
{\ct RADIATIVE\_INCIDIENT\_FLUX\_AST}           & Selection List    &         &            & 0      \\ \hline
