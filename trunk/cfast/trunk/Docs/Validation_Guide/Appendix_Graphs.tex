...
\begin{figure}[h!]
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_01_Wall_Temp_2} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_02_Wall_Temp_2} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_03_Wall_Temp_2} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_04_Wall_Temp_2} \\
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_05_Wall_Temp_2} &
\includegraphics[height=2.2in]{FIGURES/WTC/WTC_06_Wall_Temp_2}
\end{tabular*}
\label{WTC_Wall_02}
\end{figure}
