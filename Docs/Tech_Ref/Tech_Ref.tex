...
\noindent Sum Eqs. \ref{eq:lower} and \ref{eq:upper}, noting that $\dbydt{V_l}=-\dbydt{V_u}$ since $\ddt(V_l+V_u)=dV/dt=0$, and from the ideal gas law that $\rho_l T_L=\rho_u T_U = P/R$ to give
\begin{eqnarray}
...
\end{equation}
\noindent and from Eq. \ref{eq:ODE_VU}
\begin{equation}
