...
The \ct{DIAG} namelist is intended for model verification and developer diagnostics, not normal scenarios. These parameters can only be entered manually in the input file using a single \ct{DIAG} namelist record.
\begin{description}
