...
\end{tabular*}
\caption[Results of case {\ct radiation\_3.in}]{Expected and CFAST calculated incident heat fluxes due to vapor emission (left) and wall emission (right) for the case {\ct radiation\_3.in}.}
\label{fig:rad3_2}
\end{figure}
