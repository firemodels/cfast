...
\noindent is the outgoing radiative flux at the $j$'th wall surface (See Eq.~(17-15) in Siegel and Howell~\cite{SiegelandHowell:1981})\ where $\dq_{{\rm r},j}''$ is the net radiative flux striking the wall surface found using Eq.~\ref{RTE}. Eq.~\ref{eq:qoutb} is derived by solving 
