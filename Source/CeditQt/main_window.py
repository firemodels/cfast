...
class CeditMainWindow(QMainWindow):
    ...
    def refresh_reference_lists(self, *_args):
        ...
        self.wall_vents_tab.set_compartments(self.compartments_tab.compartments)
        self.wall_vents_tab.set_target_ids(target_ids)
        self.ceiling_floor_vents_tab.set_compartments(self.compartments_tab.compartments)
        self.ceiling_floor_vents_tab.set_target_ids(target_ids)
        self.mechanical_vents_tab.set_compartments(self.compartments_tab.compartments)
        self.mechanical_vents_tab.set_target_ids(target_ids)
        self.fires_tab.set_compartments(self.compartments_tab.compartments)
        self.fires_tab.set_target_ids(target_ids)
        self.targets_tab.set_compartment_ids(compartment_ids)
        self.targets_tab.set_fires(self.fires_tab.fires)
        ...
        self.detection_suppression_tab.set_compartments(self.compartments_tab.compartments)
