...
{\ct FILE\_TYPE}    & Selection List   &          &         &        \\ \hline
{\ct TYPE}    & Selection List   &          &         &        \\ \hline
{\ct CRITERIA}    & Real   &          &         &  {      \\ \hline
{\ct FIRST\_MEASUREMENT}    & Character   &          &         &        \\ \hline
{\ct FIRST\_NAME}    & Character   &          &         &        \\ \hline
{\ct SECOND\_MEASUREMENT}    & Character   &          &         &        \\ \hline
{\ct SECOND\_NAME}    & Character   &          &         &        \\ \hline
\end{longtable}
\end{minipage}
...
&CALC  ID = 'Fire Room Ion Detector'
    ...
    FIRST_MEASUREMENT = 'Simulation Time'  FIRST_NAME = 'Time'
    SECOND_MEASUREMENT = 'Sensor Activation'  SECOND_NAME = 'Ionization Detector Room 1' /
\end{lstlisting}
