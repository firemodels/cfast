...
Stated in this way, conservation of energy is the first law of thermodynamics.  The heat source term, $\dqi$, consists of the fire's heat release rate, convective losses to walls, and radiation exchange. The layer temperature, mass and volume are related to the compartment pressure via the ideal gas law:
\begin{equation}
...
\noindent after assuming that $\ml \Tl/\Vl=\mmu \Tu/\Vu = P/R$.
