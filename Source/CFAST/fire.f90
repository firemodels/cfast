...
! --------------------------- heskestad -------------------------------------------
    ...
    xf = 1.0_eb
    if (xfx<=sqrt(area)/2.or.xfy<=sqrt(area)/2) xf = 1.0_eb ! V&V experiments show no effect for walls
...
! --------------------------- get_gas_temp_velocity -------------------------------------------
    ...
    do i = 1,n_fires
        ...
        if (fireptr%room==iroom) then
            ...
            xf = 1.0_eb
            if (xfx<=sqrt(fireptr%firearea)/2.or.xfy<=sqrt(fireptr%firearea)/2) xf = 1.0_eb ! V&V experiments show no effect for walls
