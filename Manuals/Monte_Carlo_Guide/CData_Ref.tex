...
\begin{description}
  ...
  \item[PARAMETER\_HEADER] specifies the column title for this input field in the parameters file, {\ct <project>\_parameters.csv}.
