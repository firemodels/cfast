...
\begin{description}
  ...
  \item[SCENARIO\_TITLE\_ARRAY] no clue what this one does
  ...
  \item[INDEX\_TYPE] This seems superfluous ... Can't you just tell from which one does not have default values? 
  \item[NUMBER\_IN\_INDEX] Again, can't you just tell by how many values are input?
