...
module  interfaces
    ...
    y_trace, n_C, n_H, n_O, n_N, n_Cl, source_o2, lower_o2_limit, activated_room, activated_sprinkler, activated_time, &
    ...
    double precision, intent(in) :: pyrolysis_rate, molar_mass, entrainment_rate, h_c, y_soot, y_co, y_trace, &
