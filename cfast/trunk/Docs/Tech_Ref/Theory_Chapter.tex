...
\be
   T_{\rm cj} = T_\infty + T_\infty \, \dQ^{* \, 2/3}_H \, \left\{ \begin{array}{l@{\quad}l}
...
\be
   U_{\rm cj} = \sqrt{g \, H} \, \dQ^{* \, 1/3}_H \left\{ \begin{array}{l@{\quad}l}
   3.61 & r/H \le 0.17 \\[0.1in]
   1.06 \, \left( r/H \right)^{-0.69} & 0.17 < r/H < 4.0 \end{array} \right.
\ee
...
If the detector or sprinkler is outside the ceiling jet layer or in a compartment without a fire, the upper layer temperature and a default velocity of 0.1 m/s is used.
