...
Support for validation experiments and the preparation of the CFAST and FDS manuals has been provided by the Office of Nuclear Regulatory Research of the U.S. Nuclear Regulatory Commission (US NRC). Thanks to Mark Salley and Jason Dreisbach for their efforts.
...
For the NIST/NRC tests, Alex Maranghides was in charge of the Large Fire Laboratory at NIST where these tests were conducted, and helped to design the experiments. Thanks also to technicians Laurean Delauter, Jay McElroy, and Jack Lee who constructed and conducted these validation experiments
at NIST.

Finally, thanks to VTT, Finland, for their contribution of experimental data,
