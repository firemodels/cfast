...
\item 90 \% of the predictions by CFAST are within 29 \% of experimental measurements, higher than the estimated experimental uncertainty in this validation exercise.  User's should take this higher uncertainty into account when using predictions from the model.
\item There are a limited number of plume temperature measurements in the data set. A more definitive conclusion about the accuracy of CFAST in predicting plume temperature would require more experimental data.
\end{itemize}
