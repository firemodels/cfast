...
\be \dbydt{V_U} = \frac{1}{P \gamma} \brackets{\brackets{\gamma -1} \dot h_U - V_U \dbydt{P}} \ee

\be \dbydt{T_U} = \frac{1}{c_p \rho_U V_U} \brackets{\brackets{\dot h_U - c_p \dot m_U T_U}+ V_U \dbydt{P}} \ee

\be \dbydt{T_L} = \frac{1}{c_p \rho_L V_L} \brackets{\brackets{\dot h_L - c_p \dot m_L T_L}+ V_L \dbydt{P}} \ee
...
\be  \mathrm{C_vH_wO_xN_yCl_z} +  \nu_\OTWO \, \mathrm{O_2}  \rightarrow  \nu_\COTWO \, \mathrm{CO_2} + \nu_\HTWOO \, \mathrm{H_2O} + \nu_\CO \, \mathrm{CO} +
     \nu_\So \, \mathrm{Soot}  + \nu_\NTWO \, \mathrm{N_2} + \nu_\HCl \mathrm{HCl} + \nu_\HCN \mathrm{HCN} \label{stoich} \ee
where the stoichiometric coefficients $\nu_\OTWO$, $\nu_\COTWO$, etc. represent appropriate molar ratios for a stoichiometric balance of the equation and are defined as
...
\ee
which are defined by user input of the yields as appropriate.  The remaining stoichioimetry falls directly from the chemical balance as

\be
  \nu_\HTWOO = \frac{w}{2} - \frac{M_\F}{M_\HCl} \; y_\HCl -  \frac{M_\F}{M_\HCN} \; y_\HCN \label{HTWOO_yield}
\ee

\be
  \nu_\COTWO = v - \frac{M_\F}{M_\CO} \; y_\CO - \frac{M_\F}{M_\HCN} \; y_\HCN -\frac{M_\F}{M_\So} \; y_\So
\ee

\begin{eqnarray} \nu_\OTWO &=& \nu_\COTWO + \frac{\nu_\HTWOO}{2} + \frac{\nu_\CO}{2} - \frac{x}{2}  \nonumber \\
 &=& \brackets{v - \frac{M_\F}{M_\CO} \; y_\CO - \frac{M_\F}{M_\HCN} \; y_\HCN - \frac{M_\F}{M_\So} \; y_\So} + \brackets{\frac{w}{4} - \frac{M_\F}{2 M_\HCl} \; y_\HCl -  \frac{M_\F}{2 M_\HCN} \; y_\HCN} + \brackets{\frac{M_\F}{2 M_\CO} \; y_\CO} - \frac{x}{2} \nonumber \\
 &=& \brackets{v - \frac{M_\F}{2 M_\CO} \; y_\CO - \frac{M_\F}{2 M_\HCl} \; y_\HCl - \frac{3 M_\F}{2 M_\HCN} \; y_\HCN - \frac{M_\F}{M_\So} \; y_\So} + \frac{w}{4} - \frac{x}{2}
\end{eqnarray}
...
In CFAST, the calculation of combustion chemistry is implemented on a carbon-basis rather than a fuel-basis since the actual composition of the fuel is typically not precisely known. For this, the mass balance inherent in eq \ref{stoich} is used as follows

\be  \dm_f +  \dm_\OTWO =    \dm_\COTWO \, + \dm_\CO + \dm_\So + \dm_\HTWOO \
      + \dm_\HCl + \dm_\HCN \label{eqCFASTfiremassbalance} 
 \ee
      
 \be   \dm_f +  \dm_\OTWO =  \dm_\COTWO \, + \frac{y_\CO}{y_\COTWO}\dm_\COTWO \
       + \frac{y_\So}{y_\COTWO}\dm_\COTWO + 9\frac{H}{C}\frac{\dm_f}{f_\C} + y_\HCl\dm_f \
       + y_\HCN\dm_f
 \ee
 
 where  $f_\C = 1+\frac{H}{C}+\frac{HCl}{C}+\frac{HCN}{C}+\frac{O}{C}$. Noting that for most hydrocarbon fuels, $\dm_\OTWO \approx \dm_f\frac{H_\C}{1.32x10^7}$ or $\dm_f\frac{H_\C}{1.32x10^7} -\frac{\dm_f}{f_\C}\frac{O}{C}$ for fuels with oxidizer in the fuel,
 
 \be \dm_f \brackets{\brackets{1+\frac{H_\C}{1.32x10^7} -\frac{O/C}{f_\C}}- \  
        \brackets{\frac{9 H}{C}\frac{1}{f_\C} + y_\HCl  + y_\HCN}}= \dm_\COTWO \
        \brackets{1+\frac{y_\CO}{y_\COTWO} + \frac{y_\So}{y_\COTWO}}
 \ee

Since $f_\C$ is just the mass ratio of fuel to carbon, we can solve for $\dm_\COTWO$ as

\begin{eqnarray} \dm_\COTWO &=& \frac{\dm_f \brackets{\brackets{1+\frac{H_\C}{1.32x10^7} -\frac{O/C}{f_\C}}- \nicefrac{\brackets{\frac{9 H}{C} +  y_\HCl f_\C  + y_\HCN f_\C}}{f_\C}}}{1+\frac{y_\CO}{y_\COTWO} + \frac{y_\So}{y_\COTWO}} \nonumber \\
	&=& \frac{\dm_f \brackets{1+\frac{H_\C}{1.32x10^7} -\frac{O/C}{f_\C}}- \nicefrac{\brackets{\frac{9 H}{C} +  \frac{HCl}{C}  + \frac{HCN}{C}}}{f_\C}}{1+\frac{y_\CO}{y_\COTWO} + \frac{y_\So}{y_\COTWO}} \label{eqCFASTcarbonbalance}
\end{eqnarray}

$y_\CO$/$y_\COTWO$, $y_\So$/$y_\COTWO$, $H$/$C$, $O$/$C$, $y_\HCl$, and $y_\HCN$ are direct CAST inputs, so production species rates follow from eq \ref{eqCFASTcarbonbalance}. $y_\CO$/$y_\COTWO$, $y_\So$/$y_\COTWO$, $y_\HCl$, and $y_\HCN$ are typically available from material test data. $H$/$C$ and $O$/$C$ are properties of the fuel.   
...
\be H = -1.02 D + 0.235 \brackets{\frac{Q_f}{1000}}^{2/5} \ee
