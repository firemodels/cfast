...
The meat and potatoes of the fire definition are the time histories. There are three important variables that have the largest impact on the running of CFAST. The first two are obvious, the time and HRR entries. However, the third is often overlooked, the area. When the area has a significant impact on the entrainment of the fire. Typically fire areas that are much two small for the HRR can result in the model giving strange answers and even failing. 
