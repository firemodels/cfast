...
\usepackage{tocbasic} % Fix table of contents sections from overlapping section titles

\usepackage{listings}
\usepackage{textcomp}
\usepackage{footmisc}
\definecolor{lbcolor}{rgb}{0.96,0.96,0.96}
\definecolor{codegreen}{rgb}{131,187,126}
\definecolor{codegray}{RGB}{138,143,145}
\definecolor{codeblue}{RGB}{43,64,231}
\definecolor{codeorange}{RGB}{234,149,48}
\lstset{
...
\lstdefinelanguage{cdata} {morekeywords={number_of_cases,seeds,write_seeds,parameter_file,work_folder,output_folder,fyi,
...
Jason Floyd \\
Jonathan Hodges \\
{\em UL Research Institutes' Fire Safety Research Institute, Columbia, Maryland}
}
...
\newcommand{\FED}{{\tiny \hbox{FED}}}
\newcommand{\UHC}{{\tiny \hbox{UHC}}}
...
\newcommand*{\centcell}[2]{\multicolumn{1}{#1}{#2}}
