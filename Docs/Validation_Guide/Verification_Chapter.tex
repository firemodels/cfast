...
\begin{equation}
 h = \frac{C|T_{\rm g} - T|^{1/3}}{1000}
\end{equation}
where $C$ is an empirical coefficient determined to be 1.31 for targets that are oriented parallel to the walls. Figure ~\ref{rad2} shows how the surface temperature for each of the plates and the rod increases with respect to time.
