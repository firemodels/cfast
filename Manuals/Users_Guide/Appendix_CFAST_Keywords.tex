...
&VENT ID = 'VVENT 1', TYPE = 'CEILING', COMP_IDS = 'Comp 3', 'Comp 2',
      AREA = 1., SHAPE = 'ROUND', /
&INSF ID = 'Wood_Wall', COMP_ID = 'Comp 2',
      LOCATION = 2.5, 5., 1.5, FIRE_ID=''Wood Wall' /
&FIRE ID = 'Wood Wall', CARBON = 6., HYDROGEN = 10., OXYGEN = 5.,
      HEAT_OF_COMBUSTION = 18100., RADIATIVE_FRACTION = 0.33 /
&TABL ID = 'Wood Wall', LABELS = 'TIME', 'HRR' ,'AREA', 'CO_YIELD', 'SOOT_YIELD' /
&TABL ID = 'Wood Wall', DATA =     0.,    0.,    0.05,   0.006,      0.015 /
&TABL ID = 'Wood Wall', DATA =     0.,    8000., 9.0,    0.006,      0.015 /
...
\label{tbl:FIRE} \\
\hline
\multicolumn{5}{|c|}{{\ct FIRE} (Fixed Fire Parameters)} \\
\hline \hline
\endfirsthead
\caption[]{Continued} \\
\hline
...
{\ct TABLE\_ID}*          & Character     & Section \ref{info:FIRE}                 &                             &                 \\ \hline
\end{longtable}
\end{minipage}
...
\renewcommand\footnoterule{}
\begin{longtable}{@{\extracolsep{\fill}}|l|l|l|l|l|}
\caption[Fire Parameters ({\ct INSF} namelist group)]{For more information see Section~\ref{info:FIRE}.}
\label{tbl:FIRE2} \\
\hline
\multicolumn{5}{|c|}{{\ct INSF} (Individual Instance of a Fire Object)} \\
\hline \hline
\endfirsthead
\caption[]{Continued} \\
\hline
...
{\ct FIRE\_ID} & Character        & Section \ref{info:FIRE}                 & kJ/kg                       &            \\ \hline
...
\endhead
\parbox{1.5in}{\bf Parameter}    & \parbox{1in}{\bf Type}  & \parbox{1in}{\bf Reference}  & \parbox{1in}{\bf Units}  & \parbox{1in}{\bf Default Value} \\ \hline
{\ct LABELS}\footnote{ * indicates a required input for each {\ct FIRE} input included in the input file.} *                & Character Array        & Section \ref{info:FIRE}                 &                        &              \\ \hline
{\ct ID}*                   & Character   & Section \ref{info:FIRE}                 &                             &                 \\ \hline
