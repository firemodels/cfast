...
An algebraic equation for wall surface temperature can be derived using Fourier's law
\be
   \dq'' = -k \, \frac{dT}{dx}  \label{eq:fourier}
\ee

\noindent so that the temperature gradient, $dT/dx$, within a wall surface is consistent with the heat flux, $\dq''$,
