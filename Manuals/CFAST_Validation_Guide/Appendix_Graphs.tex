...
The primary purpose of the UL/NFPRF experiments was to measure sprinkler activation times for a series of heptane spray burner fires. To determine activation times, thermocouples were affixed to each sprinkler, and a sudden drop in temperature indicated activation. These same thermocouple temperatures can be compared to ceiling jet temperature predictions. Referring to Fig.~\ref{layout}, the chosen measurements are thermocouples 89 (black), 77 (red), 76 (green), and 98 (blue). The sprinklers at these same locations are numbered 38, 20, 13, and 1, respectively. These locations were chosen because the thermocouples were not wetted by the sprinkler spray. Note that no sprinklers were installed for Test~11.
