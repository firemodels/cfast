module cfast_types
    ...
    type ssout_type
        ...
        character(50) :: venttype           ! WVENT, CFVENT, MVENT, or LEAK. Only needed for vents
        integer :: room1                    ! from or top room number. Only needed for vents
        integer :: room2                    ! to or bottom room number. Only needed for vents
        integer :: counter                  ! vent number to distiguish multiple vents between a room pair. Only needed for vents
    end type ssout_type
