...
\be q_c\dprime = h A_S \brackets{T_g - T_s} \ee
...
\be h = C {|T_g - T_s|}^{1/3} \ee

where $C$ is an emperical coefficient (1.52 for the horizontal floors and ceilings and 1.31 for the vertical walls) \cite{Holman:1990}, $T_g$ is the gas temperature adjacent to the surface, and $T_s$ is the surface temperature.
