...
! --------------------------- ssHeadersNormal -------------------------------------------
    ...
    integer, parameter :: maxhead = 1+8*nrooms+5+9*mxfire
...
! --------------------------- ssHeadersSpecies -------------------------------------------
    ...
    ! local variables
    integer, parameter :: maxhead = 1+7*nrooms+5+7*mxfire
...
!time   ceiling	u-wall  l-wall floor  flux  fire surface gas convect
    ...
    integer, parameter :: maxhead = 1+9*nrooms+14*mxtarg+4*mxdtect
...
! --------------------------- ssHeadersSMV -------------------------------------------
    ...
    integer, parameter :: maxhead = 1+8*nrooms+4*mxfire+2*mxhvents+3*mxfslab*mxhvents+2*mxvvents+2*mxext
