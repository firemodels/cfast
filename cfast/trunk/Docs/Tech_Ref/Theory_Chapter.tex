...
\be
   ...
   2930 \, \dQ_{\rm eff}^{2/5} \brackets{\dm_{14}/\doh_{14}}^{1.77} &  0 \leq \brackets{\dm_{14}/\doh_{14}}<0.0026 \\[.1in]
   55   \, \dQ_{\rm eff}^{2/5} \brackets{\dm_{14}/\doh_{14}}^{1.10} &  0.0026 \leq \brackets{\dm_{14}/\doh_{14}}<0.006 \label{eq:McCaffreyPlumeInverse} \\[.1in]
   3    \, \dQ_{\rm eff}^{2/5} \brackets{\dm_{14}/\doh_{14}}^{0.53} &  0.006 \leq \brackets{\dm_{14}/\doh_{14}} \end{array} \right.
\ee
...
Radiation heat transfer is approximated using a limited number of radiating wall surfaces, four in the fire room and two everywhere else~\cite{Forney_radiation}. The following assumptions are:
\begin{itemize}
