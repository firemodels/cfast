...
These folders contain the CFAST input files for the CFAST validation suite. These cases are run and processed by CFASTbot. The experimental data is found in another repository [firemodels/exp](https://github.com/firemodels/exp). Publically available test reports may be found [here](https://drive.google.com/drive/folders/0B-EZ4HlrI6VDT2R5SjNFOGtIdTg).
