...
\newcommand{\Plumeavg}{20} % keep
\newcommand{\Speciesavg}{29} % keep
\newcommand{\Targfluxavg}{56} % keep
\newcommand{\Abstargfluxavg}{22}
\newcommand{\Abstargtempavg}{20}
\newcommand{\Surfacefluxavg}{33} % keep
\newcommand{\Surfacetempavg}{27} % keep
...
\include{Temperature_and_Heat_Flux_Chapter}
