...
{\ct FRONT\_SURFACE\_ORIENTATION}      		  & Selection List   & Section \ref{info:DEVC}     &  see footnote\footnote{Indicates where the front surface of the target is facing. Allowable input are UP, DOWN, FRONT, BACK, LEFT, RIGHT to indicate one of the compartment surfaces or a FIRE\_ID for a fire contained within the compartment. With a FIRE\_ID, the calculated normal vector can change with the position or heat release rate of the fire to point towards a point 1/3 of the flame height above the base of the fire.}                 &                 \\ \hline
