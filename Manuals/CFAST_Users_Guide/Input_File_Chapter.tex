...
\item[O2 concentration] (default units: kg/kg, default value: 0.23 kg/kg):
Initial values for ambient O2 concentration inside and outside the structure. The default value is 0.23 kg/kg.
The default N2 concentration is 1.0 minus the default O2 concentration or 0.77 kg/kg.
\end{description}
