...
{\ct VENT\_RAMP\_ID}\footnote{Associated ramp specifies the fraction of vent width for wall vents, the fraction of vent area or ceiling and floor vents, or fraction of flow for mechanical vents.}  					 & Character  		  & Section \ref{info:RAMP}      &                             &                 \\ \hline
