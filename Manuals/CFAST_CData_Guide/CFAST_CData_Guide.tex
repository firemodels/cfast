...
\begin{description}
  ...
  \item[WRITE\_VALIDATION\_OUTPUT] (default value, .FALSE.): If true the batch and script files include the -v option for CFAST to printout extra information that is not generally of value. 
\end{description}
...
\begin{figure}
\begin{center}
\includegraphics[width=6.0000in]{../CFAST_Validation_Guide/FIGURES/flashover.pdf}\\
\end{center}
