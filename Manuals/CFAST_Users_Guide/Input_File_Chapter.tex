...
\begin{description}
\item[ID] (namelist: \ct{ID}) Unique name of the fire.
...
\item[Referenced Fire] (namelist: \ct{FIRE_ID}) The name of the associated fire definition for this fire instance can be selected from a list of fire definitions.
\end{description}
...
\item[HRR] (namelist: \ct{HRR}) Heat release rate as a function of time (kW).
