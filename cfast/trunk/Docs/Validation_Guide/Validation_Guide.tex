...
\newcommand{\HGLfurnlow}{-43} % ranges for NBS furniture HGL
...
\newcommand{\Plumefmsnl}{13} % average for FM/NBS tests, not including test 21
...
\newcommand{\nbscorrtempavg}{14} % average absolute value HGL NBS corridors tests
\newcommand{\nbscorrhgtavg}{21} 
