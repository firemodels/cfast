...
\begin{itemize}
    \item Relevant documentation for the model: Description of the theoretical basis of the model \cite{CFAST_Tech_Guide_8}\, instructions for its use are contained in a separate user's guide \cite{CFAST_Users_Guide_8}, and model assessment information is contained in a separate verification and validation guide \cite{CFAST_Valid_Guide_8}.
