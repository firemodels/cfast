...
\item The UL/NIST Vents tests show particularly high ceiling jet temperature estimates compared to experimental data.  Like the upper layer temperature predictions, this is likely due to the large size of the vents relative to those included in the original experimental correlations used by CFAST.
\end{itemize}
