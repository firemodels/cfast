...
#Region " Windows Form Designer generated code "
    ...
    "from: http://netcontrols.org/nplot/wiki/"
        ...
        REM Controls.Add(Label7)
        REM Controls.Add(Label6)
        REM Controls.Add(Label5)
        REM Controls.Add(AboutCompileDate)
        REM Controls.Add(AboutRevisionDate)
        REM Controls.Add(AboutRevision)
