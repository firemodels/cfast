...
\label{Activation Time (Temperature Surrogate)}
\label{Activation Time (Smoke Obscuration)}
...
\includegraphics[width=3.0in]{SCRIPT_FIGURES/ScatterPlots/Smoke_Alarm_Activation_Time} &
\includegraphics[width=3.0in]{SCRIPT_FIGURES/ScatterPlots/Smoke_Alarm_Activation_Time_bySmoke} \\
\multicolumn{2}{c}{\includegraphics[width=3.0in]{SCRIPT_FIGURES/ScatterPlots/Sprinkler_Activation_Time}} \\
\end{tabular*}
