...
{\ct COMP\_IDS}*\footnote{ * indicates a required input for each {\ct VENT} input included in the input file. Additional inputs may be required depending on the type of vent.}     	   			         & Character Doublet        & Section \ref{info:VENT}      &                             &                 \\ \hline
...
{\ct OFFSET}       					 & Real 		  & Section \ref{info:VENT}      & m                           &      0,0        \\ \hline
{\ct VENT\_RAMP\_ID}\footnote{Associated ramp specifies the fraction of vent width for wall vents.}  					 & Character  		  & Section \ref{info:RAMP}      &                             &                 \\ \hline
