...
\ct{LEAK_AREA}                           & Real Doublet           & Section \ref{info:COMP}         & m$^2$/m$^2$        & \\ \hline
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=1.46\hsize\raggedright\arraybackslash}X|>{\hsize=0.89\hsize\raggedright\arraybackslash}X|>{\hsize=0.57\hsize\raggedright\arraybackslash}X|>{\hsize=0.95\hsize\raggedright\arraybackslash}X|>{\hsize=1.13\hsize\raggedright\arraybackslash}X|}
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=1.72\hsize\raggedright\arraybackslash}X|>{\hsize=1.04\hsize\raggedright\arraybackslash}X|>{\hsize=0.67\hsize\raggedright\arraybackslash}X|>{\hsize=0.6\hsize\raggedright\arraybackslash}X|>{\hsize=0.97\hsize\raggedright\arraybackslash}X|}
...
\ct{GAS_ABSORPTION_SUB_MODEL}\footnote{\ct{GAS_ABSORPTION}, if included, must be either \ct{CALCULATED} or \ct{CONSTANT}}
                                         & Selection List         &                                 &                    & \ct{CALCULATED} \\ \hline
\ct{GAS_TEMPERATURE}\footnote{If included, \ct{GAS_TEMPERATURE}, \ct{PARTIAL_PRESSURE_H2O}, and \ct{PARTIAL_PRESSURE_CO} are all required.\label{DIAGgpp}}
                                         & Real                   &                                 & \degc              & \\ \hline
...
\ct{PARTIAL_PRESSURE_CO}\footref{DIAGgpp} & Real                   &                                 & Pa                 & \\ \hline
...
\ct{RADSOLVER}\footnote{\ct{RADSOLVER}, if included, must be either \ct{DEFAULT} or \ct{RADNET}.}
                                         & Selection List         &                                 &                    & \ct{DEFAULT} \\ \hline
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=0.63\hsize\raggedright\arraybackslash}X|>{\hsize=0.99\hsize\raggedright\arraybackslash}X|>{\hsize=0.63\hsize\raggedright\arraybackslash}X|>{\hsize=1.83\hsize\raggedright\arraybackslash}X|>{\hsize=0.92\hsize\raggedright\arraybackslash}X|}
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=1.46\hsize\raggedright\arraybackslash}X|>{\hsize=1.14\hsize\raggedright\arraybackslash}X|>{\hsize=0.73\hsize\raggedright\arraybackslash}X|>{\hsize=0.61\hsize\raggedright\arraybackslash}X|>{\hsize=1.06\hsize\raggedright\arraybackslash}X|}
...
\ct{FILE_TYPE} \footnote{\ct{FILE_TYPE} must be one of the CFAST spreadsheet outputs: \ct{NORMAL}, \ct{FLOW}, \ct{MASS}, \ct{SPECIES}, or \ct{WALL}.}

                                         & Selection List         &                                 &                    & \\ \hline
\ct{FIRST_DEVICE}                        & Character              &                                 &                    & \\ \hline
\ct{FIRST_MEASUREMENT}                   & Character              &                                 &                    & \\ \hline
\ct{ID}                                  & Character              &                                 &                    & \\ \hline
\ct{SECOND_DEVICE}                       & Character              &                                 &                    & \\ \hline
\ct{SECOND_MEASUREMENT}                  & Character              &                                 &                    & \\ \hline
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=0.83\hsize\raggedright\arraybackslash}X|>{\hsize=1.09\hsize\raggedright\arraybackslash}X|>{\hsize=0.58\hsize\raggedright\arraybackslash}X|>{\hsize=1.67\hsize\raggedright\arraybackslash}X|>{\hsize=0.83\hsize\raggedright\arraybackslash}X|}
...
\ct{TOP}\footref{req:wallvent} & Real                  & Section \ref{info:VENT}     & m                                  &                                 \\ \hline &  & \\ \hline
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=1.09\hsize\raggedright\arraybackslash}X|>{\hsize=1.43\hsize\raggedright\arraybackslash}X|>{\hsize=0.76\hsize\raggedright\arraybackslash}X|>{\hsize=0.63\hsize\raggedright\arraybackslash}X|>{\hsize=1.09\hsize\raggedright\arraybackslash}X|}
...
\noindent
\renewcommand\footnoterule{}
\begin{xltabular}{\textwidth}{|>{\hsize=0.93\hsize\raggedright\arraybackslash}X|>{\hsize=1.21\hsize\raggedright\arraybackslash}X|>{\hsize=0.49\hsize\raggedright\arraybackslash}X|>{\hsize=1.43\hsize\raggedright\arraybackslash}X|>{\hsize=0.94\hsize\raggedright\arraybackslash}X|}
...
\begin{xltabular}{\textwidth}{|>{\hsize=0.37\hsize\raggedright\arraybackslash}X|>{\hsize=1.44\hsize\raggedright\arraybackslash}X|>{\hsize=1.62\hsize\raggedright\arraybackslash}X|>{\hsize=0.57\hsize\raggedright\arraybackslash}X|}
