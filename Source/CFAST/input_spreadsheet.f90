module spreadsheet_input_routines
    ...
    use utility_routines, only: upperall, set_heat_of_combustion, countargs, readcsvformat
    ...
    public spreadsheet_input, readcsvformat
    ...
    logical :: lend
        ...
        call readcsvformat (iofili, rarray, carray, nrow, ncol, 1, -1, numr, numc, lend, iofill)
        close (iofili)
