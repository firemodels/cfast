...
For the same scenario as the previous example, gas tenability can be calculated.  A total of 0.026 kg of CO$_2$, and 0.001 kg of CO are produced by the fire.
