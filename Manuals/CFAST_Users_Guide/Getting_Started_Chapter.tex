...
\item[Visualizations] allows specification of one or more 2-D and 3-D visualizations to be added to the simulation for viewing with Smokeview. Note that these can require significantly more computational time than a basic CFAST simulation without visualizations.
\end{description}
