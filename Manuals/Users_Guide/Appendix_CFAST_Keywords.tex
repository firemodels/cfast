...
{\ct CEILING\_JET\_SUB-MODEL}     & Selection List   &          &         &  ON      \\ \hline
{\ct CONDUCTION\_SUB-MODEL}     & Selection List   &          &         &  ON      \\ \hline
{\ct CONVECTION\_SUB-MODEL}      & Selection List   &          &         & ON      \\ \hline
{\ct DASSL\_DEBUG\_PRINT}            & Selection List   &          &         & OFF     \\ \hline
{\ct DEBUG\_PRINT}                          & Selection List   &          &         & OFF     \\ \hline
{\ct DOOR\_JET\_FIRE\_SUB-MODEL}  & Selection List &        &         & ON       \\ \hline
{\ct ENTRAINMENT\_SUB-MODEL }   & Selection List    &         &          & ON       \\ \hline 
{\ct F}\footnote{If included, both {\ct F} and {\ct T} are required.}          & Real Array       &                  &  \degc         &                 \\ \hline
{\ct FIRE\_SUB-MODEL}                     & Selection List   &          &          & ON       \\ \hline
...
{\ct HORIZONTAL\_FLOW\_SUB-MODEL} & Selection List &     &           & ON       \\ \hline
{\ct KEYBOARD\_INPUT}                    & Selection List    &          &           & ON      \\ \hline
{\ct MECHANICAL\_FLOW\_SUB-MODEL} & Selection List &      &           & ON      \\ \hline
...
{\ct RADIATION\_SUB-MODEL}           & Selection List    &         &            & ON      \\ \hline
...
{\ct VERTICAL\_FLOW\_SUB-MODEL} & Selection List &            &             & ON      \\ \hline
\end{longtable}
\end{minipage}
