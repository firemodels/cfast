...
\caption[Example Smokeview Visualization for a Three Compartment Test Case]{Example Smokeview Visualization for a Three Compartment Test Case with Two Fires (\ct User\_Guide\_Example.in)}
\end{center}
\end{figure}
